    ...
    <footer className='footer'>
      <GeneralContainer className='footer__container'>
        <div className='footer__layout__wrapper'>
          <a href='/' className='footer__home__link'>
        ...
        <div className='footer__socials__wrapper'>
          <a href='https://www.facebook.com/' className='footer__social__link'>
            <FacebookLogo />
          </a>

          <a href='https://www.twitter.com/' className='footer__social__link'>
            <TwitterLogo />
          </a>
        </div>
      </GeneralContainer>
