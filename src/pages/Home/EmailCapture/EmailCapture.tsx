        ...
        <section className="email__capture">
            <GeneralContainer>
                <div className="email__capture__body">
                    ...
                    <h2 className="email__capture__headline heading heading-200">Stay up-to-date with what we're doing</h2>
                </div>
                <form
                    className="form"
                ...
                >
                    ...
                    >
                        ...
                        {isInvalidEmail
                            ? <p className="form__error__message"><i>{formManager.errors.email}</i></p>
                            : null}
                    </fieldset>
                    
                    <button className="form__submit button button-thick button--primary--red" type="submit">Contact Us</button>
                </form>
            </GeneralContainer>
        </section>
    )
